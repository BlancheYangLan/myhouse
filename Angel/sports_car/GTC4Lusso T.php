...
<?php   
  $sqlstr1="select * from paoche where madel='GTC4Lusso T' ";		
   ...
   <div class="container"><!--栅格布局-->
     <div class="row" >
       ...
       <div class="col-xs-10 col-sm-10"><!--栅格布局2-->
          <div class="col-xs-8 col-sm-8" style="height:350px;"><img src="img/GTC4Lusso T.jpg" height="100%" width="100%"></div>
