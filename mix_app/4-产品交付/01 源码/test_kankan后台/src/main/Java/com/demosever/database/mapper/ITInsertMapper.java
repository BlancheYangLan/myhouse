 ...
 * @Version 1.0.0
 **/
public interface ITInsertMapper {
    /**
     * 登录查询验证
     * @param
     * @param
    ...
    @Select("UPDATE t_kankan_hotvideo SET videoPreviewQuantity = #{preview} WHERE videoId = #{id};")
    public List<TViodhot> querypreview(@Param("preview") Integer preview,@Param("id") Integer id) throws Exception;
}
