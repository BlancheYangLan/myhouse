...
public interface ITVoidMapper {
    ...
    @Select("select * from t_kankan_hotvideo limit #{interrupted},#{endpoint};")
    public List<TViodhot> queryvoid(@Param("interrupted") Integer interrupted,@Param("endpoint") Integer endpoint) throws Exception;
